...
```mermaid
flowchart TD
    NASA["🏛️ NASA Commercial Partnership"]
    NASA --> COTS["COTS · 2006\n$396M · Dev Falcon 9 + Dragon"]
    NASA --> CRS["CRS · 2008+\n~$1.6B · ISS cargo delivery"]
    NASA --> CCTCAP["CCtCap · 2014\n$2.6B · Crew Dragon"]
    NASA --> HLS["HLS · 2021\n$2.89B · Starship lunar lander"]
    COTS -->|"Enabled"| CRS
    CRS -->|"Proved reliability"| CCTCAP
    CCTCAP -->|"Validated crew"| HLS
```
