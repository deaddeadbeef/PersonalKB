...
```mermaid
flowchart TD
    NSSL["🔐 NSSL Certification\n2015 · Broke ULA monopoly"]
    NSSL --> LAUNCH["🚀 Launch Services\nGPS III · NROL · USSF"]
    NSSL --> PH2["📋 Phase 2 Awards\nSpaceX 40% · ULA 60%\n2020–2027"]
    SPX2["🛡️ Starshield\nMilitary Starlink variant\nEncrypted · Earth obs"]
    LAUNCH --> RAPID["⚡ Rapid Response\nHigh cadence = crisis launch"]
    SPX2 --> DEF["🏛️ Defense Infrastructure\nComms · ISR · Hosted payloads"]
```
