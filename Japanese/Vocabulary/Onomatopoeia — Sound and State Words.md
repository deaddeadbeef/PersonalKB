...
```mermaid
flowchart TD
    A[Japanese Onomatopoeia] --> B["擬音語 Giongo<br/>Actual sounds"]
    A --> C["擬態語 Gitaigo<br/>States / feelings"]
    B --> D["ワンワン dog bark<br/>ザーザー heavy rain"]
    C --> E["キラキラ sparkling<br/>ドキドキ heart pounding"]
    style A fill:#e8f5e9
    style B fill:#e3f2fd
    style C fill:#fff3e0
```
