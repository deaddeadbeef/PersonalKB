---
tags: [japanese, grammar, n3, formal]
up: "[[Grammar Overview]]"
confidence: verified
freshness: stable
...
```mermaid
flowchart TD
    A[Formal Expressions] --> B["である literary copula"]
    A --> C["において at/in formal"]
    A --> D["に関して regarding"]
    A --> E["によると according to"]
    style A fill:#e8f5e9
```
...
|---------|---------|---------|
| によると | According to | 予報によると (according to the forecast)<br>![[n3form-018-yohouniyoruto.mp3]]|
| によって | Depending on / By | 国によって (depending on the country)<br>![[n3form-019-kuniniyotte.mp3]]|
| により | Due to (formal) | 事故により (due to an accident)<br>![[n3form-020-jikoniyori.mp3]]|
...
|---------|---------|----------|
| である<br>![[n3form-021-dearu.mp3]]| is (formal written) | だ |
| であります<br>![[n3form-022-dearimasu.mp3]]| is (ultra-polite) | です |
| ではないか<br>![[n3form-023-dehanaika.mp3]]| isn't it? (rhetorical) | じゃない? |
