...
```mermaid
flowchart TD
    A[Active Voice] --> B{Voice?}
    B -->|Passive| C["Ru-verb: られる<br/>U-verb: あ段 + れる"]
    B -->|Causative| D["Ru-verb: させる<br/>U-verb: あ段 + せる"]
    B -->|Causative-Passive| E["Ru-verb: させられる<br/>U-verb: あ段 + せられる"]
    style A fill:#e8f5e9
    style C fill:#e3f2fd
    style D fill:#fff3e0
    style E fill:#fce4ec
...
| Group | Rule | Example |
|-------|------|---------|
| G1 | -u → -areru | 読む → 読まれる (yomareru)<br>![[n4pass-002-yomu-yomareru.mp3]]|
| G2 | -ru → -rareru | 食べる → 食べられる (taberareru)<br>![[n4pass-003-taberu-taberareru.mp3]]|
| Irr | する → される, くる → こられる<br>![[n4pass-004-suru-sareru-kuru-korareru.mp3]]| |
...
| Group | Rule | Example |
|-------|------|---------|
| G1 | -u → -aseru | 読む → 読ませる (yomaseru)<br>![[n4pass-007-yomu-yomaseru.mp3]]|
| G2 | -ru → -saseru | 食べる → 食べさせる (tabesaseru)<br>![[n4pass-008-taberu-tabesaseru.mp3]]|
| Irr | する → させる, くる → こさせる<br>![[n4pass-009-suru-saseru-kuru-kosaseru.mp3]]| |
...
|------|---------|---------|
| 食べる<br>![[n4pass-011-taberu.mp3]]| I eat | Active |
| 食べられる<br>![[n4pass-012-taberareru.mp3]]| I am eaten | Passive |
| 食べさせる<br>![[n4pass-013-tabesaseru.mp3]]| I make someone eat | Causative |
| 食べさせられる<br>![[n4pass-014-tabesaserareru.mp3]]| I am made to eat | Causative-passive |
