---
tags: [japanese, grammar, n5, counting]
up: "[[Grammar Overview]]"
confidence: verified
freshness: stable
...
```mermaid
flowchart TD
    A[Time Expressions] --> B["Specific Time に<br/>三時に at 3:00"]
    A --> C["Duration を/間<br/>三時間 for 3 hours"]
    A --> D["Relative Time<br/>昨日・今日・明日"]
    A --> E["Counters<br/>〜つ, 〜人, 〜本"]
    style A fill:#e8f5e9
```
