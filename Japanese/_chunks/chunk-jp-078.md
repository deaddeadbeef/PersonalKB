...
# Minimal Pairs — Why Pitch Matters

> **箸 HAshi (chopsticks) vs 橋 haSHI (bridge). 雨 Ame (rain) vs 飴 aME (candy). Wrong pitch rarely prevents comprehension but marks you as foreign. Tools: OJAD, Suzuki-kun, NHK発音アクセント辞典.**

## 🎯 Intuition

**The Core Idea:** Understanding Minimal Pairs — Why Pitch Matters is fundamental to Japanese language mastery.
