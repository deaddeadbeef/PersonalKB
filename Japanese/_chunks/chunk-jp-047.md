...
> **G1: -u → -eru (書く→書ける). G2: -ru → -rareru (食べる→食べられる). する→できる. 来る→来られる. Note: 食べられる is both potential AND passive — context disambiguates.**

## 🎯 Intuition

**The Core Idea:** Understanding Potential Form — Expressing Ability is fundamental to Japanese language mastery.
