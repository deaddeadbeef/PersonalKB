---
tags: [japanese, chunk, kenjoogo]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Kenjōgo Formation — Lowering Yourself

> **Pattern 1: お + stem + する (お持ちする). Pattern 2: special verbs — 参る (go/come), 申す (say), いただく (eat/receive), 拝見する (see), いたす (do), おる (be), 存じる (know), 差し上げる (give).**

## 🎯 Intuition

**The Core Idea:** Understanding Kenjōgo Formation — Lowering Yourself is fundamental to Japanese language mastery.
