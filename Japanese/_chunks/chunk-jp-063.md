---
tags: [japanese, chunk, food-vocab]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Restaurant Vocabulary — Immediate Utility

> **メニュー (menu), 注文 (order), 会計 (bill). Set phrases: いただきます (before eating), ごちそうさま (after eating), おすすめ (recommendation). Cooking: 焼く (grill), 煮る (simmer), 揚げる (deep fry).**

## 🎯 Intuition

**The Core Idea:** Understanding Restaurant Vocabulary — Immediate Utility is fundamental to Japanese language mastery.
