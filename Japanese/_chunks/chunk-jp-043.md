...
# How 'If' Evolves Across JLPT Levels

> **N5: simple たら. N4: four conditionals (たら/ば/なら/と). N3: hypothetical variants (としたら/とすれば). N2: extreme hypotheticals (ものなら/ようものなら). Each level adds nuance to the same concept.**

## 🎯 Intuition

**The Core Idea:** Understanding How 'If' Evolves Across JLPT Levels is fundamental to Japanese language mastery.
