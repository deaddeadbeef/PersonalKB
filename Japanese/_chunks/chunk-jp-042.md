...
> **こと: abstract nominalization — 読むことが好き (I like reading, conceptually). の: concrete nominalization — 走るのが見えた (I saw running, concrete event). という names/defines: 東京というまち (the city called Tokyo).**

## 🎯 Intuition

**The Core Idea:** Understanding Nominalization — こと vs の is fundamental to Japanese language mastery.
