...
# Shadowing — Repeat with 0.5s Delay

> **Shadow = repeat speech while audio continues playing. Activates both Wernicke's (comprehension) and Broca's (production) areas simultaneously. Passive listening only activates comprehension. Most effective combined technique.**

## 🎯 Intuition

**The Core Idea:** Understanding Shadowing — Repeat with 0.5s Delay is fundamental to Japanese language mastery.
