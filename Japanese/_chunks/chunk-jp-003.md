...
# Dakuten and Handakuten — Sound Modifications

> **Dakuten (゛) voices consonants: か→が (ka→ga), さ→ざ (sa→za), た→だ (ta→da), は→ば (ha→ba). Handakuten (゜) creates p-sounds: は→ぱ (ha→pa). Combination kana use small や/ゆ/よ: きゃ (kya), しゅ (shu), ちょ (cho).**

## 🎯 Intuition

**The Core Idea:** Understanding Dakuten and Handakuten — Sound Modifications is fundamental to Japanese language mastery.
