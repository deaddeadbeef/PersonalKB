...
# Five Levels of Shadowing

> **1. Mumbling: match rhythm only (1 week). 2. Synchronized: match every sound (2 weeks). 3. Prosody: focus on pitch accent (ongoing). 4. Content: process meaning while shadowing (advanced). 5. Delayed: wait 2-3 seconds (professional).**

## 🎯 Intuition

**The Core Idea:** Understanding Five Levels of Shadowing is fundamental to Japanese language mastery.
