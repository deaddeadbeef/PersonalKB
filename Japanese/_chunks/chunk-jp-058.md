---
tags: [japanese, chunk, onomatopoeia]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Gitaigo — State/Manner Words (No Sound!)

> **擬態語: describe states without sound. キラキラ (sparkling), ふわふわ (fluffy), ピカピカ (shiny), ドキドキ (heart pounding), イライラ (irritated), ワクワク (excited). Essential for natural Japanese — ~4,500 exist.**

## 🎯 Intuition

**The Core Idea:** Understanding Gitaigo — State/Manner Words (No Sound!) is fundamental to Japanese language mastery.
