---
tags: [japanese, chunk, kanji-review]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Kanji Review Strategy — Recognition vs Recall

> **Recognition (seeing kanji → meaning) is easier than recall (meaning → writing kanji). For modern life, recognition + typing is sufficient. Handwriting practice is optional but helps with: character distinction, stroke order intuition, reading handwritten text.**

## 🎯 Intuition

**The Core Idea:** Understanding Kanji Review Strategy — Recognition vs Recall is fundamental to Japanese language mastery.
