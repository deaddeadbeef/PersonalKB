...
# i+1 Principle — Learn in Context

> **Sentences should contain exactly ONE unknown word. Source from textbooks, anime, news. This is comprehensible input theory applied to vocabulary. Context sentences beat isolated word lists.**

## 🎯 Intuition

**The Core Idea:** Understanding i+1 Principle — Learn in Context is fundamental to Japanese language mastery.
