...
# Modern Hiragana Usage

> **Hiragana is used for: grammatical particles (は, が, を), verb/adjective inflections (okurigana), native Japanese words without kanji, and furigana (reading aids above kanji). It's the first writing system taught to Japanese children.**

## 🎯 Intuition

**The Core Idea:** Understanding Modern Hiragana Usage is fundamental to Japanese language mastery.
