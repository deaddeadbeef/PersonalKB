---
tags: [japanese, chunk, body-vocab]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Body and Health — Complaint Pattern

> **Common pattern: [body part]が痛いです. 頭痛 (headache), 腹痛 (stomachache), 腰痛 (back pain). 風邪をひきました (caught a cold). 薬 (medicine), 病院 (hospital), 薬局 (pharmacy).**

## 🎯 Intuition

**The Core Idea:** Understanding Body and Health — Complaint Pattern is fundamental to Japanese language mastery.
