---
tags: [japanese, chunk, te-form]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Te-Form Extensions — Swiss Army Knife

> **ている (progressive/state), てある (intentional result), ておく (preparatory), てしまう (completion/regret), てみる (try doing), てくる/ていく (directional), てほしい (want someone to do).**

## 🎯 Intuition

**The Core Idea:** Understanding Te-Form Extensions — Swiss Army Knife is fundamental to Japanese language mastery.
