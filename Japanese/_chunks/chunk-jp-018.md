---
tags: [japanese, chunk, kanji-n4]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# N4 Kanji — Abstract Concepts Emerge

> **N4 adds ~200 kanji with more abstract meanings: 同 (same), 別 (separate), 特 (special), 変 (strange/change). On'yomi compounds dominate: 会社 (kaisha, company), 図書館 (toshokan, library), 病院 (byōin, hospital).**

## 🎯 Intuition

**The Core Idea:** Understanding N4 Kanji — Abstract Concepts Emerge is fundamental to Japanese language mastery.
