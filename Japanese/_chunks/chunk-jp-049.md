---
tags: [japanese, chunk, quotation]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Quotation Patterns — と言う, と思う

> **と言う: direct/indirect quote. と思う: thinking — use 思います for yourself only; use 思っている for others' thoughts. という: naming/defining — 寿司という食べ物 (the food called sushi).**

## 🎯 Intuition

**The Core Idea:** Understanding Quotation Patterns — と言う, と思う is fundamental to Japanese language mastery.
