---
tags: [japanese, chunk, greetings]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Self-Introduction — Fixed Format Speech

> **自己紹介 structure: Name → Affiliation → Personal detail → よろしくおねがいします. This is REHEARSED, not improvised. Practice until you can deliver smoothly without thinking.**

## 🎯 Intuition

**The Core Idea:** Understanding Self-Introduction — Fixed Format Speech is fundamental to Japanese language mastery.
