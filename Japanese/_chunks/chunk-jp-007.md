...
> **Common confusion pairs: シ (shi) vs ツ (tsu) — stroke direction differs. ソ (so) vs ン (n) — similar strokes. The chōon mark ー extends vowels in katakana only: ケーキ (kēki, cake), コーヒー (kōhī, coffee).**

## 🎯 Intuition

**The Core Idea:** Understanding Katakana Confusing Pairs is fundamental to Japanese language mastery.
