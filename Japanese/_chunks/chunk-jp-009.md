...
# Six Categories of Kanji (六書)

> **Pictographs (象形): 山, 川, 木. Ideographs (指事): 上, 下, 一. Compound ideographs (会意): 休 (person+tree=rest). Phono-semantic (形声): ~80% of kanji — semantic radical + phonetic component, e.g., 清 = 氵(water) + 青(sei).**

## 🎯 Intuition

**The Core Idea:** Understanding Six Categories of Kanji (六書) is fundamental to Japanese language mastery.
