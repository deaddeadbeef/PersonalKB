...
# Counter Sound Changes (連濁)

> **Counters starting with h/f change: 1,6,8,10 → h becomes pp (一本 ippon, 六本 roppon). 3 → h becomes b (三本 sanbon). These sound changes (rendaku) are the hardest part of counters.**

## 🎯 Intuition

**The Core Idea:** Understanding Counter Sound Changes (連濁) is fundamental to Japanese language mastery.
