...
# Five Practical Register Levels

> **1. タメ口 (casual): close friends. 2. です/ます: strangers, default. 3. Keigo light: senior colleagues. 4. Full keigo: clients, business. 5. 最高敬語: imperial (rare). Always start MORE formal, let the senior person initiate downshift.**

## 🎯 Intuition

**The Core Idea:** Understanding Five Practical Register Levels is fundamental to Japanese language mastery.
