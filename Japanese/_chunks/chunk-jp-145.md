---
tags: [japanese, chunk, grammar-review]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Grammar Acquisition — Conscious to Unconscious

> **Stage 1: Learn the rule (textbook). Stage 2: Recognize in input (reading/listening). Stage 3: Use with effort (speaking/writing). Stage 4: Automatic use (fluency). Most grammar points need 50-100 encounters to reach Stage 4.**

## 🎯 Intuition

**The Core Idea:** Understanding Grammar Acquisition — Conscious to Unconscious is fundamental to Japanese language mastery.
