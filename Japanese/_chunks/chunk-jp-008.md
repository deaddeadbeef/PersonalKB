---
tags: [japanese, chunk, kanji]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# On'yomi vs Kun'yomi — Two Reading Systems

> **Each kanji can have multiple readings. 音読み (on'yomi): Sino-Japanese, from Chinese pronunciation, used in compounds. 訓読み (kun'yomi): native Japanese, used when kanji stands alone. Example: 山 = サン (san, on) in 富士山 vs やま (yama, kun) alone.**

## 🎯 Intuition

**The Core Idea:** Understanding On'yomi vs Kun'yomi — Two Reading Systems is fundamental to Japanese language mastery.
