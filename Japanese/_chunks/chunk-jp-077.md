...
# Four Pitch Patterns in Tokyo Dialect

> **平板 (heiban, flat ~55%): no drop, LHH. 頭高 (atamadaka, head-high ~5%): HLL. 中高 (nakadaka, middle-high ~35%): LHHL. 尾高 (odaka, tail-high): LHH+L(particle). Heiban and odaka are indistinguishable without a following particle.**

## 🎯 Intuition

**The Core Idea:** Understanding Four Pitch Patterns in Tokyo Dialect is fundamental to Japanese language mastery.
