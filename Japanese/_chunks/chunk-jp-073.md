---
tags: [japanese, chunk, work-vocab]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Workplace Vocabulary — Office Life

> **会社 (company), 上司 (boss), 同僚 (colleague), 部下 (subordinate). Titles: 社長 (CEO), 部長 (dept head), 課長 (section chief). Actions: 出勤する (go to work), 残業する (overtime), 転職する (change jobs).**

## 🎯 Intuition

**The Core Idea:** Understanding Workplace Vocabulary — Office Life is fundamental to Japanese language mastery.
