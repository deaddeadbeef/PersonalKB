...
# Giongo — Sound-Mimicking Words

> **擬音語: actual sounds. ドンドン (banging), ガタガタ (rattling), ザーザー (heavy rain), バタン (door slam), ピンポン (doorbell). These are written in katakana for emphasis.**

## 🎯 Intuition

**The Core Idea:** Understanding Giongo — Sound-Mimicking Words is fundamental to Japanese language mastery.
