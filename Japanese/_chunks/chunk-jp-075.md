---
tags: [japanese, chunk, weather-vocab]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Weather Vocabulary — Daily Use

> **晴れ (sunny), 曇り (cloudy), 雨 (rain), 雪 (snow), 風 (wind), 台風 (typhoon), 蒸し暑い (humid). Season associations: 春=桜, 夏=花火, 秋=紅葉, 冬=雪.**

## 🎯 Intuition

**The Core Idea:** Understanding Weather Vocabulary — Daily Use is fundamental to Japanese language mastery.
