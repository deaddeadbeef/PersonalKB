...
# Copula Sentences — XはYです

> **The simplest pattern: X は Y です。私は学生です (I am a student). Negative: じゃありません. Past: でした. Questions: add か. Question words: 何 (what), 誰 (who), どこ (where), いつ (when).**

## 🎯 Intuition

**The Core Idea:** Understanding Copula Sentences — XはYです is fundamental to Japanese language mastery.
