---
tags: [japanese, chunk, volitional]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Volitional Form — Intention and Suggestions

> **G1: -u → -ō (書く→書こう). G2: -ru → -yō (食べる→食べよう). する→しよう. 来る→来よう. Uses: let's do (食べよう), I think I'll do (帰ろう), trying to do (Vようとする).**

## 🎯 Intuition

**The Core Idea:** Understanding Volitional Form — Intention and Suggestions is fundamental to Japanese language mastery.
