---
tags: [japanese, chunk, particles]
confidence: verified
tier-coverage: [intuition, core, deep-dive, practice]
---

# Core Particles — は, が, を, に, で

> **は (topic), が (subject/new info), を (object), に (target/time/location), で (means/action location). Japanese uses particles to mark function; English uses word order. は vs が: は for known/topic, が for new/focused information.**

## 🎯 Intuition

**The Core Idea:** Understanding Core Particles — は, が, を, に, で is fundamental to Japanese language mastery.
