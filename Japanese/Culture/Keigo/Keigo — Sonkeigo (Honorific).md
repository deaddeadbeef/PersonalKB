---
tags: [japanese, culture, keigo, sonkeigo]
up: "[[Culture Overview]]"
confidence: verified
freshness: stable
...
```mermaid
flowchart TD
    A["敬語 Keigo"] --> B["丁寧語 Teineigo<br/>Polite — です/ます"]
    A --> C["尊敬語 Sonkeigo<br/>Honorific — elevate others"]
    A --> D["謙譲語 Kenjōgo<br/>Humble — lower yourself"]
    B --> E["Baseline for all<br/>formal situations"]
    C --> F["いらっしゃる, おっしゃる<br/>ご覧になる"]
    D --> G["参る, 申す<br/>いたす"]
    style A fill:#e8f5e9
    style B fill:#e3f2fd
    style C fill:#fff3e0
