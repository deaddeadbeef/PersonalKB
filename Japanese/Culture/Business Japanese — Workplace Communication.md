---
tags: [japanese, culture, business]
up: "[[Culture Overview]]"
confidence: verified
...
```mermaid
flowchart TD
    A["Business Japanese"] --> B["名刺交換<br/>Business cards"]
    A --> C["敬語<br/>Keigo in office"]
    A --> D["メール<br/>Email etiquette"]
    A --> E["会議<br/>Meeting language"]
    style A fill:#e8f5e9
```
