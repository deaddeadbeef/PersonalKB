---
tags: [japanese, listening, phase-2, audio, native-audio]
...
Continue the same native-audio spine you chose in Phase 1 unless it is clearly not working.

| If your spine is... | Phase 2 audio job | Do not do this |
| --- | --- | --- |
| Genki I | Use the current lesson dialogue, vocabulary, practice, reading, and listening-comprehension audio through OTO Navi | Jump around the book to chase isolated grammar points |
| Irodori A1 | Use the current can-do lesson audio and speaking/listening practice | Treat the English explanation as the lesson and skip the task audio |
...
For Weeks 5-8, use [[Second Month Japanese Study Plan]] to keep particles, forms, counters, and daily-life vocabulary tied to weekly proof. For Weeks 9-12, use [[Third Month Japanese Study Plan]] to keep kanji, pronunciation, interactions, and polite service tied to authentic audio.
...
Treat audio as usable for Phase 2 only if it meets these conditions:

- The source is an official course, publisher audio, public broadcaster lesson, tutor recording, or native speaker recording.
- The segment has text, transcript, or lesson context you can check.
- You can replay the exact same segment across multiple days.
- The segment is short enough to shadow without turning the session into passive listening.
- For pitch accent, counter readings, and kanji word readings, you can verify the word with [[Pronunciation and Audio Accuracy]].
...
- Which local clip made the target sound or pattern clearer?
