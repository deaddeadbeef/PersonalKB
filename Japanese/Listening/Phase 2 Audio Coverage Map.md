---
tags: [japanese, listening, phase-2, audio, coverage]
...
> Use this page when asking: "What should I listen to while studying this Phase 2 page?" It maps the required [[Phase 2 — Building Blocks]] sequence to local page clips, authentic audio, and pronunciation QA.

## Coverage Rule

Phase 2 audio support has three layers:

| Layer | Source | Job |
| --- | --- | --- |
| Local drill | Embedded MP3 clips on the current Phase 2 page | Repeat particles, forms, words, counters, kanji readings, and scripted lines inside Obsidian |
...
| [[N5 Grammar — Time and Counting]] | 77 | Scheduling or classroom audio | Covered by QA | Hear dates, times, and number timing |
| [[Counters — The Japanese Counting System]] | 36 | Shopping/classroom/tutor audio for counter readings | Needs QA for sound changes | Verify irregular counter readings before memorizing |
| [[Core 500 — Daily Life Vocabulary]] | 131 | Daily-life course or NHK audio | Covered by QA | Pair vocabulary clusters with spoken example sentences |
| [[Thematic Vocabulary — Food and Drink]] | 27 | Restaurant or shopping audio | Covered by QA | Practice ordering and food vocabulary aloud |
| [[Thematic Vocabulary — Home and Daily Life]] | 19 | Routine or home-life audio | Covered by QA | Narrate simple daily routines |
| [[Kanji — How Kanji Work]] | 16 | Course vocabulary audio for kanji words | Covered by QA | Keep kanji tied to spoken words, not isolated symbols |
| [[Radicals — The Building Blocks]] | 21 | Native word audio when radical examples become vocabulary | Covered by QA | Learn radicals visually while keeping example words pronounceable |
| [[Kanji Learning Strategies]] | 2 | Uses current course vocabulary audio | Routes to QA | Use strategy; drill readings on the kanji pages |
| [[Kanji N5 Essentials]] | 66 | Course/tutor audio for first kanji vocabulary | Covered by QA | Hear readings in words before testing recall |
| [[Pronunciation — Difficult Sounds for English Speakers]] | 40 | OJAD/NHK/Forvo or tutor checks | Primary QA target | Fix r, long vowels, small っ, devoicing, and rhythm |
| [[Conversation Patterns — Daily Interactions]] | 19 | Daily-interaction dialogue audio | Covered by QA | Shadow everyday scripts |
| [[Conversation Patterns — Shopping and Restaurants]] | 16 | Service interaction audio | Covered by QA | Practice shop and restaurant role-plays |
| [[Shadowing — Technique and Practice Guide]] | 0 | Uses spine segment | Routes to QA | Apply shadowing to the week's authentic clip |
| [[Podcast Guide — Japanese Learning Podcasts]] | 2 | Optional controlled beginner podcast | Routes to QA | Add only after course audio is consistent |
...
- A planning, strategy, or technique page with zero embedded clips, if it routes to [[Phase 2 Authentic Audio Spine]] and the relevant content page.
- A copyrighted native source linked externally instead of mirrored into the vault.
- A local clip used for repetition after [[Pronunciation and Audio Accuracy]] says it is safe for the job.

These are real gaps:

- A required Phase 2 content page with no local clips and no route to authentic audio.
- A counter, kanji-reading, or pitch-accent claim that cannot be checked against a native/accent source.
- A shadowing assignment that says "listen to audio" without naming the exact spine segment or page-level local clip set.
