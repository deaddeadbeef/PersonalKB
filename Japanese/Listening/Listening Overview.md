...
Listening is often the hardest skill for Japanese learners. The language is spoken quickly, particles are swallowed, and pitch accent carries meaning.

## Why Listening Is Hard
- **Speed:** Native speakers average 7.5 syllables/second
- **Particle reduction:** は, を, を are often barely pronounced ![[listen-019-particles-ha-wo.mp3]]
- **Homophones:** Many words sound identical (橋/端/箸 — hashi means bridge/edge/chopsticks) ![[listen-020-hashi-hashi-hashi.mp3]]
- **Pitch accent:** Distinguishes otherwise identical words
- **Contractions:** ている → てる, ておく → とく ![[listen-021-teiru-teru-teoku-toku.mp3]]
...
- [[Phase 2 Local Audio Practice]] — ordered local drill ladder for N5 mechanics and beginner interactions
- [[Phase 2 Audio Assignment Ladder]] — weekly authentic/local/evidence targets for Weeks 5-12
...
- [[Phase 3 Local Audio Practice]] — ordered local drill ladder for N4 grammar, pitch, media, and register recognition
- [[Phase 3 Audio Assignment Ladder]] — block-level authentic/local/pitch/evidence targets for Phase 3
...
### Intermediate
- [[Phase 4 Local Audio Practice]] — ordered local drill ladder for N3 grammar, kanji, keigo, business, culture, and discourse timing
- [[Phase 4 Audio Assignment Ladder]] — block-level native-speed/local/register/evidence targets for Phase 4
...
## Techniques
- [[Shadowing — Technique and Practice Guide]] — the #1 technique for listening + speaking
- **Extensive listening:** Background immersion (podcasts, radio, TV)
- **Intensive listening:** Focused practice with transcripts
...
For Phase 2, use [[Phase 2 Audio Assignment Ladder]] to choose the week target, then pair [[Phase 2 Authentic Audio Spine]] with [[Phase 2 Local Audio Practice]]. Use the embedded clips on the current grammar, vocabulary, kanji, or conversation page when the ladder points you to a topic that needs more examples. Use [[Phase 2 Audio Coverage Map]] when you need to know which page-level clips and authentic segment belong together.

For Phase 3, use [[Phase 3 Audio Assignment Ladder]] to choose the current block, then pair [[Phase 3 Authentic Audio Spine]] with [[Phase 3 Local Audio Practice]]. Use the embedded clips on the current N4, pitch, vocabulary, media, or culture page when the ladder points you to a topic that needs more examples. Use [[Phase 3 Audio Coverage Map]] when intermediate listening or media practice needs a repeatable authentic segment instead of random immersion. Record weekly proof in [[Phase 3 Weekly Review]].
...
| 5-15 min | [[Phase 2 Local Audio Practice]] plus a segment from [[Phase 2 Authentic Audio Spine]] | Beginner/N5 |
| 10-20 min | [[Phase 3 Local Audio Practice]] plus a segment from [[Phase 3 Authentic Audio Spine]] | N4/early intermediate |
| 15-30 min | [[Phase 4 Local Audio Practice]] plus a segment from [[Phase 4 Authentic Audio Spine]] | N3/intermediate |
| 20-45 min | [[Phase 5 Local Audio Practice]] plus a native source from [[Phase 5 Authentic Audio Spine]] | N2/N1 direction |
