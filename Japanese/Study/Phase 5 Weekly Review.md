...
At the start of the week, copy the current block from [[Phase 5 Audio Assignment Ladder]] into [[Authentic Audio Evidence Log#Current Assignment]]. For Block 1, use [[Eleventh Month Japanese Study Plan]] as the daily execution path. For Block 2, use [[Twelfth Month Japanese Study Plan]] as the daily execution path.
