...
```mermaid
flowchart TD
    A[Pitch Accent Patterns] --> B["平板型 Heiban<br/>Flat — no drop"]
    A --> C["頭高型 Atamadaka<br/>Drops after mora 1"]
    A --> D["中高型 Nakadaka<br/>Rises then drops"]
    A --> E["尾高型 Odaka<br/>Drops after last mora"]
    style A fill:#e8f5e9
    style B fill:#e3f2fd
    style C fill:#fff3e0
    style D fill:#fce4ec
...
## Practice Method
1. Look up 5 new words per day in OJAD
