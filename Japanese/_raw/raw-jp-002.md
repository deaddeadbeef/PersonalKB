...
# Raw: Katakana — System and Modern Usage

> **Katakana (片仮名) developed from parts of Chinese characters used in Buddhist monasteries. Unlike hiragana's cursive origin, katakana comes from angular fragments — hence 片 (kata, "partial/fragment").**

## 🎯 Intuition

**The Core Idea:** Understanding Raw: Katakana — System and Modern Usage is fundamental to Japanese language mastery.
