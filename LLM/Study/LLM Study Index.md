...
- [[LLM/Study/Local LLM First Runtime Health Runner|Local LLM First Runtime Health Runner]]
...
- [[LLM/Study/Local LLM First Endpoint Evidence Audit Runner|Local LLM First Endpoint Evidence Audit Runner]]
...
- [[LLM/Study/Local LLM First Quality Probe Runner|Local LLM First Quality Probe Runner]]
...
- [[LLM/Study/Local LLM First Inference Evidence Pack Audit Runner|Local LLM First Inference Evidence Pack Audit Runner]]
...
- [[LLM/Study/Local LLM Capacity and SLO Planning Runner|Local LLM Capacity and SLO Planning Runner]]
...
- [[LLM/Study/Local LLM Failure Triage Runner|Local LLM Failure Triage Runner]]
...
- [[LLM/Study/Chat Template and Tokenizer Compatibility Runner|Chat Template and Tokenizer Compatibility Runner]]
...
- [[LLM/Study/Local LLM Structured Format Remediation Proof - 2026-06-16|Local LLM Structured Format Remediation Proof - 2026-06-16]] — explicit structured IDs plus deterministic rendering cleared the held `C-01` strict-format probe while loose structured attempts stayed diagnostic
...
- [[LLM/Study/Local LLM First Model Pull Runner|Local LLM First Model Pull Runner]] — audit source-recheck output, install-runner output, saved pull output, CLI/API inventory, show metadata, store decision, compatibility proof, and next route before runtime health
...
- [[LLM/Study/Local LLM First Runtime Health Runner|Local LLM First Runtime Health Runner]] — run the no-generation health probe as repeatable JSON, Markdown, CSV, and JSONL evidence before the first prompt
- [[LLM/Study/Local LLM First Smoke Request Runner|Local LLM First Smoke Request Runner]] — bind the first controlled native and OpenAI-compatible smoke prompts to runtime-health JSON, saving request, response, extracted output, status, missing layer, and next action
...
- [[LLM/Study/Local LLM First Endpoint Evidence Audit Runner|Local LLM First Endpoint Evidence Audit Runner]] — audit a first endpoint run folder for machine, model, runtime health, smoke response, pass-state debrief, template/tokenizer compatibility, security boundary, and decision proof
...
- [[LLM/Study/Local LLM First Response Debrief Runner|Local LLM First Response Debrief Runner]] — turn the saved health-bound smoke response into debrief JSON, Markdown, JSONL, converted timing, token rates, mechanism owner, and next action without sending another request
...
- [[LLM/Study/Local LLM First Quality Probe Runner|Local LLM First Quality Probe Runner]] — require passing endpoint evidence, then execute the first five private quality probes with a standard-library Python runner and save request, response, output, auto-check, CSV, Markdown, and JSONL evidence
...
- [[LLM/Study/Local LLM Security and Privacy Proof - 2026-06-16|Local LLM Security and Privacy Proof - 2026-06-16]] — record the first security/privacy runner pass for the loopback Ollama endpoint: expected model visible, hosts loopback, scoped config/log secret scan clean, and no RAG/tool/UI roots
...
- [[LLM/Study/Local LLM Capacity and SLO Planning Runner|Local LLM Capacity and SLO Planning Runner]] — validate that measured latency, throughput, concurrency, error rate, resource headroom, admission policy, security boundary, owner, and retest trigger support one local service-level objective
...
- [[LLM/Study/Local LLM Queueing and Tail Latency Field Guide|Local LLM Queueing and Tail Latency Field Guide]] — connect arrival rate, service time, p95/p99 latency, prefill/decode, KV-cache pressure, batching, and admission control to local hosting capacity decisions
...
- [[LLM/Study/Local LLM Observability and Operations Runner|Local LLM Observability and Operations Runner]] — run a no-generation service snapshot that saves `/v1/models`, loaded-model, metrics, slots, resource, redacted log-tail, privacy, and next-action evidence
...
- [[LLM/Study/Local LLM Service Lifecycle and Upgrade Runner|Local LLM Service Lifecycle and Upgrade Runner]] — validate lifecycle manifests, baseline artifacts, backups, rollback targets, route state, and before/after/rollback decisions before changing a local service
...
- [[LLM/Study/Chat Template and Tokenizer Compatibility Runner|Chat Template and Tokenizer Compatibility Runner]] — turn health-bound debrief plus template/tokenizer compatibility evidence into JSON, CSV, Markdown, and JSONL pass/hold/fail artifacts
...
- [[LLM/Study/Local LLM Calculator Tool Remediation Proof - 2026-06-16|Local LLM Calculator Tool Remediation Proof - 2026-06-16]] — see the first native calculator tool loop that turns a held arithmetic probe into a tool-backed pass
- [[LLM/Study/Local LLM Structured Format Remediation Proof - 2026-06-16|Local LLM Structured Format Remediation Proof - 2026-06-16]] — see the first app-rendered structured-output path that turns a held strict-format probe into a renderer-backed pass
