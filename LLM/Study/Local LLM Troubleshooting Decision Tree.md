...
| 12 | Should repeated prefixes have reduced prefill or TTFT? | [[LLM/Study/Local LLM Prompt Cache and KV Reuse Lab|prompt cache lab]] |
| 13 | Should speculative decoding have improved decode latency? | [[LLM/Study/Local LLM Speculative Decoding Lab|speculative decoding lab]] |
| 14 | Did lower-bit quantization, GPU offload, or KV-cache precision change memory, speed, or quality? | [[LLM/Study/Local LLM Quantization and GPU Offload Lab|quantization/offload lab]] |
| 15 | Is the answer fast but wrong, unsupported, or unusable? | [[LLM/Study/Local LLM Quality Evaluation Harness|Quality harness]] |
| 16 | Does retrieval, citation, or private data change the failure? | [[LLM/Study/Local RAG Assistant Lab|RAG lab]], [[LLM/Study/Local RAG Retrieval Evaluation and Reranking Lab|retrieval evaluation lab]], [[LLM/Study/Local RAG Minimal Python Harness|RAG harness]], and [[LLM/Study/Local LLM Security and Privacy Runbook|security runbook]] |
| 17 | Do logs, metrics, resource counters, or loaded-model state explain the failure? | [[LLM/Study/Local LLM Observability and Operations Runbook|observability runbook]] |
