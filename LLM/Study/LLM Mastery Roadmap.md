...
8. **Evaluation harness:** evaluate the RAG/tool assistant with [[LLM/Study/Local LLM Quality Evaluation Harness|Local LLM Quality Evaluation Harness]], including at least one human rubric and one LLM-as-judge rubric; run [[LLM/Study/Local LLM Judge Calibration Runner|Local LLM Judge Calibration Runner]] before the judge score can support a keep/hold/reject decision.
