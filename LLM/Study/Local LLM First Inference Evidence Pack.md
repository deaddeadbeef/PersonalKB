...
Use [[LLM/Study/Local LLM Client Harness Lab|Local LLM Client Harness Lab]] once the endpoint responds. The harness should log:
...
| streaming status | required if the UI/client streams |
