...
| Scheduler, concurrency, and SLO | queue, backpressure, KV/cache, saturation, batch policy, capacity/SLO audit | catches multi-user, long-prompt, and overload failure before deployment |
