...
| You need OpenAI-compatible client or streaming timing proof | [[LLM/Study/Local LLM OpenAI-Compatible Streaming Timing Proof - 2026-06-16]] | Non-streaming client latency, first SSE event, first visible content, reasoning chunks, usage, and final streamed text |
...
| You have an API contract and need a reusable client run | [[LLM/Study/Local LLM First Client Harness Runner]] | Python client script, request/response/output files, JSONL row, and next route; current first-smoke proof is [[LLM/Study/Local LLM OpenAI-Compatible Streaming Timing Proof - 2026-06-16]] |
...
| Request lifecycle runner | [[LLM/Study/LLM Inference Request Lifecycle Runner]] and [[LLM/Study/Local LLM Request Lifecycle Proof - 2026-06-16]] | passed: native first-smoke request lifecycle; OpenAI-compatible contrast now has client/streaming timing in [[LLM/Study/Local LLM OpenAI-Compatible Streaming Timing Proof - 2026-06-16]] but still lacks server prefill/decode split |
...
| First local endpoint | [[LLM/Study/Local LLM First Inference Proof - 2026-06-16]], [[LLM/Study/Local LLM First Endpoint Audit and Quality Probe - 2026-06-16]], [[LLM/Study/Local LLM Request Lifecycle Proof - 2026-06-16]], [[LLM/Study/Local LLM OpenAI-Compatible Streaming Timing Proof - 2026-06-16]], [[LLM/Study/Local LLM Quality Remediation Probe - 2026-06-16]], [[LLM/Study/Local LLM Calculator Tool Remediation Proof - 2026-06-16]], [[LLM/Study/Local LLM Structured Format Remediation Proof - 2026-06-16]], [[LLM/Study/Local LLM Security and Privacy Proof - 2026-06-16]], [[LLM/Study/Local LLM First Inference Evidence Pack]], [[LLM/Study/Local LLM First Endpoint Evidence Audit Runner]], and [[LLM/Study/Local LLM First Inference Evidence Pack Audit Runner]] | passed: endpoint proof, endpoint audit, native request lifecycle, OpenAI-compatible streaming timing, loopback security/privacy, calculator remediation for `K-01`, and structured-format remediation for `C-01`; evidence-pack audit still pending |
...
| One OpenAI-compatible client and streaming timing proof | [[LLM/Study/Local LLM OpenAI-Compatible Streaming Timing Proof - 2026-06-16]] |
