...
- [[LLM/Study/Local LLM First Endpoint Evidence Audit Runner|Local LLM First Endpoint Evidence Audit Runner]] — Audit the first endpoint run folder for run card, preflight, model custody, runtime health, smoke response, debrief, boundary, and decision proof
...
- [[LLM/Study/Chat Template and Tokenizer Compatibility Runner|Chat Template and Tokenizer Compatibility Runner]] — Audit model package, tokenizer, chat template, route, stop, and benchmark/quality links before blaming local model quality
