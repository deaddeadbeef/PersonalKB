...
- [[LLM/Study/Local LLM First Model Pull Runner|Local LLM First Model Pull Runner]] — Audit saved pull output, `ollama ls`, `/api/tags`, `/api/show`, store decision, compatibility proof, and next route before runtime health
