...
```mermaid
graph TD
    A[Alternative Biochemistry] --> B[Ammonia as Biosolvent]
    B --> C[High Pressure Extends Liquid Range]
    A --> D[Silicon Chemistry Limits]
    D --> E[Carbon Still More Versatile]
    A --> F[Extremophile Grounding]
    F --> G[Speculation Beyond Known Life]
```
