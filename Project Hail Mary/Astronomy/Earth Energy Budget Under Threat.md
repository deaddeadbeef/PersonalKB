...
```mermaid
flowchart TD
    A[Normal solar input] --> B[Earth absorbs ~240 W/m²]
    B --> C[Stable climate balance]
    A --> D[Astrophage dims sunlight]
    D --> E[Absorbed energy falls]
    E --> F[Ice-albedo feedback strengthens cooling]
    F --> G[Global agricultural and climate crisis]
```
