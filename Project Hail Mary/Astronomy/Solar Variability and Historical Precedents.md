...
```mermaid
flowchart TD
    A[Normal solar variability] --> B[Grand minima like Maunder and Dalton]
    B --> C[Small TSI reductions]
    C --> D[Cooling plus climate feedbacks]
    D --> E[PHM scales dimming to multi-percent]
    E --> F[Runaway ice-albedo crisis]
```
