...
```mermaid
flowchart TD
    A[Nearby real star systems] --> B[Tau Ceti]
    A --> C[40 Eridani]
    B --> D[Hail Mary investigation target]
    D --> E[Adrian and Astrophage mystery]
    C --> F[Rocky's home system]
    F --> G[Eridian worldbuilding]
```
