...
← [[PHM Novel - Chapter 16]] | [[Chapter Index]] | [[PHM Novel - Chapter 18]] →
...
flowchart LR
    subgraph Present
        P1[Predator fails to appear in lab tests]
        P2[Grace and Rocky design a 10 km chain sampler]
        P3[Grace explains Rocky's fuel surplus with relativity]
        P1 --> P2 --> P3
    end
    subgraph Flashback
        F[Hatch unveils the Beetle return probes]
    end
    F -.->|backup mission logic| P2
```
