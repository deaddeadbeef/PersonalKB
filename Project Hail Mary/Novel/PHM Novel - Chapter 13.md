...
← [[PHM Novel - Chapter 12]] | [[Chapter Index]] | [[PHM Novel - Chapter 14]] →
...
flowchart LR
    subgraph Present
        P1[Rocky learns radiation killed his crew]
        P2[Rocky plans a way into Hail Mary]
        P1 --> P2
    end
    subgraph Flashback
        F[Antarctic detonations release methane]
    end
    F -.->|planetary desperation mirrors personal loss| P1
```
