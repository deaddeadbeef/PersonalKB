...
flowchart LR
    subgraph Present
        P1[Grace commits to making his death matter]
        P2[The Petrovascope confirms Tau Ceti Astrophage]
        P3[An unexplained solid object blocks the line]
    end
    subgraph Flashback
        F[Stratt explains coma-tolerance crew selection]
    end
    P1 --> P2 --> P3
    P2 -.->|memory trigger| F
```
