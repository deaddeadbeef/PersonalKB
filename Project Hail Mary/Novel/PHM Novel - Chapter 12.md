...
← [[PHM Novel - Chapter 11]] | [[Chapter Index]] | [[PHM Novel - Chapter 13]] →
...
flowchart LR
    subgraph Present
        P[Grace teaches Rocky about radiation]
    end
    subgraph Flashback
        F1[Redell scales Sahara blackpanels]
        F2[Lokken explains neutrino storage]
        F1 --> F2
    end
    P -.->|science context| F2
```
