...
flowchart LR
    subgraph Present
        P1[Mini-airlock enables object exchange]
        P2[The tape measure experiment reveals Rocky's blindness]
        P3[Grace builds tactile scheduling tools]
    end
    subgraph Flashback
        F[Stratt crushes the IP lawsuit with pardons]
    end
    P1 --> P2 --> P3
    P2 -.->|memory trigger| F
```
