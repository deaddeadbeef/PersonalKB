...
flowchart LR
    subgraph Present
        P1[Grace confirms the alien ship is real]
        P2[Mirrored engine pulses establish intent]
        P3[Grace retrieves the ammonia-scented cylinder]
    end
    subgraph Flashback
        F[Stratt's crew-selection compromises continue]
    end
    P1 --> P2 --> P3
    P2 -.->|memory trigger| F
```
