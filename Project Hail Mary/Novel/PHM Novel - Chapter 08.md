...
flowchart LR
    subgraph Present
        P1[Grace studies xenonite and sends a hull sample]
        P2[The alien ship docks against Hail Mary]
        P3[A xenonite tunnel ends with three knocks]
    end
    subgraph Flashback
        F[Dimitri's team proves Astrophage thrust]
    end
    P1 --> P2 --> P3
    P2 -.->|memory trigger| F
```
