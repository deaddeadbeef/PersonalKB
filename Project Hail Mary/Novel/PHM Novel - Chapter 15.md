...
← [[PHM Novel - Chapter 14]] | [[Chapter Index]] | [[PHM Novel - Chapter 16]] →
...
flowchart LR
    subgraph Present
        P1[Grace admits the mission is one-way]
        P2[Rocky offers surplus Astrophage]
        P3[They head for Adrian]
        P1 --> P2 --> P3
    end
    subgraph Flashback
        F[Grace learns the crew role was never fully his choice]
    end
    F -.->|reframes the cost of the mission| P1
```
