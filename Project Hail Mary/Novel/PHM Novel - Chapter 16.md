...
← [[PHM Novel - Chapter 15]] | [[Chapter Index]] | [[PHM Novel - Chapter 17]] →
...
flowchart LR
    subgraph Present
        P1[Hail Mary enters Adrian orbit]
        P2[ECU sample reveals a whole ecosystem]
        P3[Grace and Rocky identify Adrian as Astrophage's homeworld]
        P1 --> P2 --> P3
    end
    subgraph Flashback
        F[Grace trains with IVME for vacuum microbiology]
    end
    F -.->|training enables discovery| P2
```
