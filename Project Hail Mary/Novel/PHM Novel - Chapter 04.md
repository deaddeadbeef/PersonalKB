...
flowchart LR
    subgraph Present
        P[Grace's shipboard memories continue returning]
    end
    subgraph Flashback
        F1[CO₂ experiments explain Venus navigation]
        F2[Stratt reveals Project Hail Mary]
        F3[Dimitri validates Astrophage thrust]
    end
    P -.->|memory trigger| F1
    F1 --> F2 --> F3
```
