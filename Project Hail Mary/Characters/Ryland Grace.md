...
```mermaid
graph TD
    Grace[Ryland Grace<br/>Biologist] -->|friendship & collaboration| Rocky[Rocky<br/>Eridian Engineer]
    Stratt[Eva Stratt<br/>Administrator] -->|recruits & coerces| Grace
    Grace -->|crew| Yao[Commander Yáo]
    Grace -->|crew| Ily[Ilyukhina<br/>Engineer]
    Grace -->|solves via| Taumoeba[Taumoeba]
    Taumoeba -->|addresses| Crisis[Astrophage Crisis]
    Grace -->|chooses| Erid[Erid]
```
