...
```mermaid
graph TD
    Rocky[Rocky<br/>Eridian Engineer] -->|partners with| Grace[Ryland Grace]
    Rocky -->|belongs to| Erid[Eridian Civilization]
    Rocky -->|builds for| Partnership[Human-Eridian Collaboration]
    Grace -->|shares friendship with| Partnership
    Rocky -->|helps solve| Crisis[Astrophage Crisis]
    Grace -->|helps solve| Crisis
    Rocky -->|travels from| Ship[The Eridian Vessel]
```
