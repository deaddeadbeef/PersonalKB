...
```mermaid
graph TD
    Crew[Yáo & Ilyukhina<br/>Lost Crewmates] -->|their deaths isolate| Grace[Ryland Grace]
    Stratt[Eva Stratt<br/>Selector] -->|chooses| Crew
    Crew -->|served aboard| Mission[Hail Mary Mission]
    Grace -->|memorializes| Crew
    Crew -->|mirrors loss of| Rocky[Rocky]
    Mission -->|depends on| Sacrifice[Mission Sacrifice]
    Crew -->|embody| Sacrifice
```
