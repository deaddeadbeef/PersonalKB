...
```mermaid
graph TD
    Stratt[Eva Stratt<br/>Crisis Administrator] -->|authorizes| Mission[Hail Mary Mission]
    Stratt -->|coerces| Grace[Ryland Grace]
    Stratt -->|overrides| Sovereignty[National Sovereignty]
    Crisis[Astrophage Crisis] -->|creates mandate for| Stratt
    Stratt -->|triggers debate about| Ethics[Legitimacy & Ethics]
    Mission -->|aims to solve| Crisis
    Grace -->|carries out| Mission
```
